...
<div class="commento_head">
         	...
         	<span class="commenter"><?php the_commenter_link() ?></span>
...
<?php }?>
            ...
            <?php if ($comment->comment_approved == '0') echo "<p class='unapproved'>".__('আপনার কমেন্টটি মডারেশনের অপেক্ষায় আছে।',churchthemes)."</p>\n"; ?>
